...
public:
	...
	CRealRect(double l, double t, double r, double b);
...
public:
	...
	void SetResize(const UINT nID, double left, double top, double right, double bottom);
...
public: // helper classes
	...
	typedef CArray<CItem*> ItemArray;
...
private: // helper data
	...
	ItemArray	m_arrItems;		// array of controls
